...
const Perfil = () => {
    ...
    const getUserInfo = async (userId) => {
        ...
        try {
          const response = await fetch(`http://localhost/editUser.php?userId=${userId}`);
          if (response.ok) {
            const data = await response.json();
...
///// Save image to db
      const saveImageToDatabase = async (imageData, usuario) => {
        ...
        try {
          const response = await fetch('http://localhost/saveImage.php', {
            method: 'POST',
            headers: {
...
//Handle input value change
    ...
    const handleSave = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost/editUser.php', {
            method: 'POST',
            mode: 'cors',
            headers: {
                'Content-Type': 'application/json'
